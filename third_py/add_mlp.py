...
output_file = f"{args.dataset}_log_add_mlp.txt"
    ...
    with tqdm(total=args.num_epoch) as pbar:
        ...
        for epoch in range(args.num_epoch):
            ...
            if epoch % 5 == 0:
                ...
                student_score = mlp_s(emb).squeeze(dim=-1)  # Use MLP to compute scores for Student model
                
                _, score_from_ocgnn = loss_func(emb)
                
                total_score = score_from_ocgnn + student_score
