...
add_log_subdir_argument(parser, 'score_forth')
...
output_file = get_log_file(args, f"{args.dataset}_log_score_forth.txt")
    ...
    with tqdm(total=args.num_epoch) as pbar:
        ...
        for epoch in range(args.num_epoch):
            ...
            if epoch % 5 == 0:
                ...
                # calculate the ocgnn score and apply sigmoid
