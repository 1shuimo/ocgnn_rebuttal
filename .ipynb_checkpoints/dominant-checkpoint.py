...
from model_dominant import Model_dominant
from utils import *
...
with tqdm(total=args.num_epoch) as pbar:
    ...
    for epoch in range(args.num_epoch):
        ...
        # Train model
        loss, _,score ,_= model(features, adj, normal_label_idx, idx_test)
        calculate_loss_start = time.time()
        # loss, score = model(features, adj, all_idx, idx_test)
        loss.backward()
        optimiser.step()
        calculate_loss_end = time.time()
        calculate_loss_time =calculate_loss_end - calculate_loss_start
        print(f"calculate_loss_time {calculate_loss_time}")
