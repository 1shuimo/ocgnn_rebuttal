...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/root/miniconda3/lib/python3.8',
 'BLDLIBRARY': '-L. -lpython3.8',
 'BLDSHARED': 'gcc -pthread -shared -B /root/miniconda3/compiler_compat '
              '-L/root/miniconda3/lib '
              '-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed '
              '-Wl,--sysroot=/',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread -B /root/miniconda3/compiler_compat -Wl,--sysroot=/',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '-I/root/miniconda3/include',
 'CONFIGURE_LDFLAGS': '-L/root/miniconda3/lib '
                      '-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed '
                      '-Wl,--sysroot=/',
 'CONFIG_ARGS': "'--enable-shared' '--enable-ipv6' '--with-ensurepip=no' "
                "'--prefix=/root/miniconda3' "
                "'--with-tcltk-includes=-I/root/miniconda3/include' "
                "'--with-tcltk-libs=-L/root/miniconda3/lib "
                "-ltcl8.6 -ltk8.6' "
                "'CPPFLAGS=-I/root/miniconda3/include' "
                "'LDFLAGS=-L/root/miniconda3/lib "
                "-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed -Wl,--sysroot=/' "
                "'PKG_CONFIG_PATH=/root/miniconda3/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/root/miniconda3/include',
 'CONFINCLUDEPY': '/root/miniconda3/include/python3.8',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/root/miniconda3/../work/Python-3.8.10/coverage.info',
 'COVERAGE_REPORT': '/root/miniconda3/../work/Python-3.8.10/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include '
             '-I/root/miniconda3/include',
 'CXX': 'g++ -pthread -B /root/miniconda3/compiler_compat -Wl,--sysroot=/',
 'DESTDIRS': '/root/miniconda3 '
             '/root/miniconda3/lib '
             '/root/miniconda3/lib/python3.8 '
             '/root/miniconda3/lib/python3.8/lib-dynload',
 'DESTLIB': '/root/miniconda3/lib/python3.8',
 'DESTPATH': '',
 'DESTSHARED': '/root/miniconda3/lib/python3.8/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/root/miniconda3/include '
                   '/root/miniconda3/include '
                   '/root/miniconda3/include/python3.8 '
                   '/root/miniconda3/include/python3.8',
 'INCLUDEDIR': '/root/miniconda3/include',
 'INCLUDEPY': '/root/miniconda3/include/python3.8',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared -B /root/miniconda3/compiler_compat '
                '-L/root/miniconda3/lib '
                '-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed '
                '-Wl,--sysroot=/',
 'LDFLAGS': '-L/root/miniconda3/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -B /root/miniconda3/compiler_compat '
             '-L/root/miniconda3/lib '
             '-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed '
             '-Wl,--sysroot=/',
 'LDVERSION': '3.8',
 'LIBC': '',
 'LIBDEST': '/root/miniconda3/lib/python3.8',
 'LIBDIR': '/root/miniconda3/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/root/miniconda3/lib/pkgconfig',
 'LIBPL': '/root/miniconda3/lib/python3.8/config-3.8-x86_64-linux-gnu',
 'LIBRARY': 'libpython3.8.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -lutil -lrt',
 'LIBSUBDIRS': 'tkinter tkinter/test tkinter/test/test_tkinter \\',
 'LINKCC': 'gcc -pthread -B /root/miniconda3/compiler_compat -Wl,--sysroot/',
 ...
 'MACHDEPPATH': ':',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/root/miniconda3/lib/python3.8',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread -B /root/miniconda3/compiler_compat -Wl,--sysroot=/',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/root/miniconda3/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 'MODLIBS': '',
 ...
 'PY_CPPFLAGS': '-I. -I./Include '
                '-I/root/miniconda3/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/root/miniconda3/lib '
               '-Wl,-rpath=/root/miniconda3/lib -Wl,--no-as-needed '
               '-Wl,--sysroot=/',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/root/miniconda3/../work/Python-3.8.10',
 'SCRIPTDIR': '/root/miniconda3/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TCLTK_INCLUDES': '-I/root/miniconda3/include',
 'TCLTK_LIBS': '-L/root/miniconda3/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/root/miniconda3/../work/Python-3.8.10 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/root/miniconda3/../work/Python-3.8.10 '
 ...
 'abs_builddir': '/root/miniconda3/../work/Python-3.8.10',
 'abs_srcdir': '/root/miniconda3/../work/Python-3.8.10',
 'datarootdir': '/root/miniconda3/share',
 'exec_prefix': '/root/miniconda3',
 'prefix': '/root/miniconda3',
 'srcdir': '.'}
