...
add_log_subdir_argument(parser, 'ggad_2_step_reg_kl')
...
output_file = get_log_file(args, f"{args.dataset}_abnormal.txt")
with open(output_file, "a") as f:
    with tqdm(total=args.num_epoch) as pbar:
        ...
        for epoch in range(args.num_epoch):
            ...
            # 计算KL散度损失
            student_score_max_min = student_score
            teacher_score_max_min = score_from_ggad
            kl_loss = kl_loss_student_teacher(student_score_max_min, teacher_score_max_min)
