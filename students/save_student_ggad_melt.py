...
with open(output_file, "a") as f:
    with tqdm(total=args.num_epoch) as pbar:
        ...
        for epoch in range(args.num_epoch):
            ...
            if auc_stu >= 0.80:
                print(f"\n🎉 AUC threshold of 0.93 reached! Stopping training at epoch {epoch}.")
                break
...
student_model_path = os.path.join(save_dir, f"student_model_lr{args.lr}_melt_80.pth")
mlp_path = os.path.join(save_dir, f"mlp_lr{args.lr}_melt_80.pth")
